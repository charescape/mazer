(function(factory) {
  ...
  const featherIcons = /* @__PURE__ */ getDefaultExportFromCjs(featherExports);
  ...
  const bootstrapBundle = bootstrap_bundleExports;
  const isDesktop = (window2) => window2.innerWidth > 1200;
